...
import { CreateOutgoingPaymentArgs, OutgoingPayment, OutgoingPaymentPaginationResult, PaginationArgs } from '../types';
export interface OutgoingPaymentRoutes {
    ...
    create(requestArgs: ResourceRequestArgs, createArgs: CreateOutgoingPaymentArgs): Promise<OutgoingPayment>;
}
